...
CosmicRay::CosmicRay(MeshBlock *pmb, ParameterInput *pin)
{
  ...
  // For initialization and boundary
  rho_in.NewAthenaArray(n3z,n2z,n1z);
  v_in.NewAthenaArray(n3z,n2z,n1z);
  pg_in.NewAthenaArray(n3z,n2z,n1z);
  ec_in.NewAthenaArray(n3z,n2z,n1z);
  fc_in.NewAthenaArray(n3z,n2z,n1z);
